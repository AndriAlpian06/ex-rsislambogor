            ...
            <div className="container">
                <nav className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-x-4">    
                        <Link to='/' onClick={closeMenu} className={color ? 'md:text-sm font-medium lg:text-tiny px-4 py-2 text-black hover:text-white hover:bg-green-700 rounded-lg' : 'md:text-sm font-medium lg:text-tiny px-4 py-2 text-white hover:text-white hover:bg-green-700 rounded-lg'}>BERANDA</Link>

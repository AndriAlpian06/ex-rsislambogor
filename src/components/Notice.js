...
export default function () {
  ...
  return (
    ...
    <div className="bg-white">
        <div className="w-5/6 mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-4 py-4 sm:px-6 sm:py-16 lg:max-w-7xl lg:grid-cols-2" data-aos="fade-up" data-aos-duration="3000">
            <div>
